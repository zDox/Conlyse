...
from utils.formating import format_bytes, format_date

# RM ----------------------------
from utils.mock_replay import *
# -------------------------------
...
class ReplayListPage(Page):
    ...
    def setup_ui(self):
        ...
        self.theme_toggle.clicked.connect(self.app.style_manager.toggle_theme)
