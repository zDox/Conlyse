...
# Example usage with QStackedWidget
if __name__ == '__main__':
    ...
    main_window.setWindowTitle("Conflict of Nations Replay Analyser")
    main_window.setMinimumSize(1400, 800)

    # Create stacked widget
    stacked_widget = QStackedWidget()

    # Create and add the replay analyser widget
    replay_widget = ReplayListPage()
    stacked_widget.addWidget(replay_widget)
