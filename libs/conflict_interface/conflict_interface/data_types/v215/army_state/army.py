...
from ..army_state.army_action import ArmyAction
from ..army_state.army_action_result import ArmyActionResult
from ..army_state.army_enums import Aggressiveness
from ..army_state.army_enums import FightStatus
from ..army_state.army_enums import ForcedMarch
from ..army_state.commands import AttackCommand
from ..army_state.commands import Command
from ..army_state.commands import GotoCommand
...
class Army(GameObject):
    ...
    def split_and_move_unit(self, unit_type_name: str, amount: int, target_province_name: str) -> tuple[
        ...
        result = self.split_army(
            self.game.get_province_by_name(target_province_name).center_coordinate,
            tuples
        )
        return result
