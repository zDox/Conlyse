...
class ReplayHook:
    ...
    search_start_depth = 0 # Depth in the path tree at which the system starts looking for changes depth is 0 at the hook path
    search_end_depth = -1 # Depth in the path tree at which the system stops looking for changes (inclusive); If -1, depth is disregarded